...
- [ ] Approved educational resources behind access permissions
- [ ] Staff management area: review applications, record Board decisions, manage permissions, track billing separately, export register
- [ ] Application/account never auto-grants membership or resource access
- [ ] Portal fully usable while payments disabled

## Phase 3 — Payments (November target, subject to readiness)
- [ ] Protected server-side payments setting, disabled by default, blocks checkout/links/debits/reminders
- [ ] Billing states: none due, deferred, requested, paid, refunded; overdue only after approved due date
- [ ] Office confirms category, fee, currency, period, due date before any payment request
